...
if(SR_DATABASE_EXTENSION AND SR_POSTGRESQL_DRIVER)
    ...
    set(SR_PG_PORT_TARGET "src/port/libpgport_shlib.a")
    set(SR_PQ_ARCHIVE "${sr_postgresql_BINARY_DIR}/${SR_PQ_TARGET}")
    set(SR_PG_COMMON "${sr_postgresql_BINARY_DIR}/${SR_PG_COMMON_TARGET}")
    set(SR_PG_PORT "${sr_postgresql_BINARY_DIR}/${SR_PG_PORT_TARGET}")
    ExternalProject_Add(sr_libpq_build
        ...
        BUILD_COMMAND "${CMAKE_COMMAND}" -E env "PYTHONPATH=${sr_meson_SOURCE_DIR}"
            ...
            "${SR_PQ_TARGET}" "${SR_PG_COMMON_TARGET}" "${SR_PG_PORT_TARGET}"
        INSTALL_COMMAND ""
